            ...
            <div>
                ...
                <div className="row">
                    <div className="col-md-12">
                        <div class="card">
                            <img class="card-img-top img-thumbnail" src="healthnetbuy.png" height="55px" width="300px" alt="Card image cap" />
                        </div>
                    </div>
                </div>
                <br />
                    ...
                    <div className="col-md-12">
                        <div className="row">
                            <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div className="card h-100 text-white bg-danger mb-3 carddeliverydetails">
                            ...
                            <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card h-100 text-white bg-danger mb-3 cardprescriptiondetails">
                                    ...
                                    <div class="card-body">
                                        <div className="row">
                                            <div className="col-xl-12, col-lg-12 col-md-12 col-sm-12 col-12">
                                                ...
                                                <div>
                                                    <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                        <img className="img-thumbnail img-responsive" src={preview} alt="No image"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div className="row">
                    <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card text-white bg-warning mb-3 carddisclaimer">
